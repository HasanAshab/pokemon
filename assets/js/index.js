...
globalThis.selectForMultyBattle = function(id){
    //implements
...
function loadAllPokemons() {
  ...
  for (const pokemon in pokemons_meta) {
    ...
    const isSelectedForMultyBattle = true // example
    pokemonList.innerHTML += `

                  <li class="pokemon ${isSelectedForMultyBattle ? "selected-for-multy-battle" : ""}" >
