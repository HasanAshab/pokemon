   ...
   <span class="pokemon-name">${meta.name.charAt(0).toUpperCase() + meta.name.slice(1)}</span>
    ...
    <div class="right-controle-btns-cont">
     ...
     <div class="more-btns-cont">
       <button onclick="healPokemon('${meta.name}')">Heal</button>
       <button class="del-btn" onclick="deletePokemon('${meta.name}')">Delete</button>
      </div>
    </div>
