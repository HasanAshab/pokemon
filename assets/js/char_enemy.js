...
import { capitalizeFirstLetter, flagsToObj } from "./utils/helpers.js"
import {  getUserPokemonsMeta, startBattle, startUserBattle } from "./utils/dom.js";
...
async function charecterBtnsClickHandler(charecter){
 ...
 async function getPopList(charecter){
    const userPokemonsMeta = await getUserPokemonsMeta(charecter,2)
